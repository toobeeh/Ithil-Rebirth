...
/**
 * Exposes all fields present in CloudTags as a typescript
 * interface.
 */
...
/**
 * Exposes the same fields as CloudTags,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
...
/**
 * Exposes all fields present in lobs as a typescript
 * interface.
 */
export interface Lobs {
  ...
  /**  Defaults to: NULL. */
  'JSON_UNQUOTE(DcName)'?: string | null
  /**  Defaults to: NULL. */
  Name_exp_3?: string | null
}

/**
 * Exposes the same fields as Lobs,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface LobsWithDefaults {
  /**  Defaults to: NULL. */
  PlayerLobbyID?: string | null
  /**  Defaults to: NULL. */
  'JSON_UNQUOTE(DcName)'?: string | null
...
/**
 * Exposes all fields present in sps as a typescript
 * interface.
 */
export interface Sps {
  ...
  ID: string
  /**  Defaults to: NULL. */
  'DATE_ADD(CURRENT_TIMESTAMP, INTERVAL -30 SECOND)'?: Date | null
}

/**
 * Exposes the same fields as Sps,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface SpsWithDefaults {
  LobbyKey: string
  LobbyPlayerID: number
  Sprite: number
  Date: string
...
/**
 * Exposes all fields present in ThemeShares as a typescript
 * interface.
 */
export interface ThemeShares {
  ID: string
  Theme: string
}

/**
 * Exposes the same fields as ThemeShares,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface ThemeSharesWithDefaults {
  ID: string
  Theme: string
}
/**
 * Exposes all fields present in UserThemes as a typescript
 * interface.
 */
...
/**
 * Exposes the same fields as UserThemes,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface UserThemesWithDefaults {
  ID: string
  OwnerID: string
  /**  Defaults to: 1. */
  Version?: number
